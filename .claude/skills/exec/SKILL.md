...
- On an unresolvable blocker, move the ticket to **Blocked** + `agent:human` + assign Aled. Never leave it In Progress — that jams the leg and it never retries.

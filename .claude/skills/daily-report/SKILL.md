---
name: daily-report
description: Write Aled's morning brief on the Claude Code work loop by reading Linear — read-only, changes nothing. Use this whenever running the daily-report routine, or when Aled asks for a morning brief, a status digest, a stand-up, or "what needs me today" in a Linear context. Reports what awaits his approval, what needs a decision, what moved, what's blocked, and what's in flight. Apply it rather than assembling a status summary ad hoc.
---
